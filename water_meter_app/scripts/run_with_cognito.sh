...
exec "$FLUTTER" run \
  ...
  --dart-define=API_BASE_URL=https://water-meter-data-injection-env.eba-udmynr49.ap-south-1.elasticbeanstalk.com \
  ...
  --dart-define=LIVE_UPDATES_WS_URL=wss://water-meter-data-injection-env.eba-udmynr49.ap-south-1.elasticbeanstalk.com/ws/live \
